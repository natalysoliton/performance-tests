...
def init(environment: Environment, **kwargs) -> None:
    ...
    1. Генерирует тестовые данные (200 пользователей с дебетовыми и сберегательными счетами)
...
class GetOperationsScenarioUser(LocustBaseUser):
    """
    Пользователь Locust, исполняющий сценарий получения операций и статистики.
