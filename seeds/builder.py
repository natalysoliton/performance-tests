"""
SeedsBuilder — генератор тестовых данных на основании входного плана.
Работает как с HTTP, так и с gRPC клиентами.
"""
...
class SeedsBuilder:
    ...
    def build_virtual_card_result(self, user_id: str, account_id: str) -> SeedCardResult:
        ...
        Returns:
            SeedCardResult: Результат с ID выпущенной виртуальной карты
        """
    ...
    def build_user(self, plan: SeedUsersPlan) -> SeedUserResult:
        """
        Создает пользователя и согласно переданному плану:
